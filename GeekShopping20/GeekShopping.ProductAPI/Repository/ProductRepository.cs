...
namespace GeekShopping.ProductAPI.Repository
{
    public class ProductRepository : IProductRepository
    {
        ...
        {
            Product products = await _context.Products.Where(products => products.Id == id).FirstOrDefaultAsync();
        ...
        public async Task<bool> Delete(long id)
        {
            try
            {
                Product product = await _context.Products.Where(products => products.Id == id).FirstOrDefaultAsync();
                if (product == null) 
                    return false;
